...
methods_to_show <- tribble(
  ...
  "MILR (univariate cor)", "MILR (UNIV1, UNIV2, COR)", "#000000FF",
  "MILR (baseline cor)", "MILR (UNIV1, COR)", "#000000FF",
  "MILR (univariate)", "MILR (UNIV1, UNIV2)", "#000000FF",
  "MILR (baseline)", "MILR (UNIV1)", "#000000FF",
